...
clientUtils.graphInfo = function graphInfo (buckets) {
  ...
  if (buckets && graphHours > 0) {
    ...
    graphHTML += '<span style="position: absolute; bottom: 100%; right: 0%; color: darkgrey; font-size: 3vmin; line-height: normal;">' + maxBGText + '</span>';
    graphHTML += '<span style="position: absolute; top: 100%; right: 0%; color: darkgrey; font-size: 3vmin; line-height: normal;">' + minBGText + '</span>';
    let d = new Date();
    d.setHours(d.getHours() - graphHours);
    graphHTML += '<span style="position: absolute; top: 100%; left: 0%; color: darkgrey; font-size: 3vmin; line-height: normal;">' + formatTimeHHMMA(d) + '</span>';
