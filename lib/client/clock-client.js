...
function graphInfo () {
  ...
  let graphHTML = '<div id="graph" style="width: ' + graphWidth + '%; height: ' + graphHeight + '%; border: 1px solid grey; position: relative; background-color: black;">';
  ...
  for (let i in accumSGV) {
    ...
    xPct = (xPct * .9) + 5; // leave some margin since points are non-zero size
    yPct = (yPct * .9) + 5;
    let bgColor = 'green';
