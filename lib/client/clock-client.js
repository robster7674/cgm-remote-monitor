...
function graphInfo () {
  ...
  if (graphOverlaySGV != '1') {
    ...
    let maxBGText = maxMGDL;
    let minBGText = minMGDL;
    ...
    graphHTML += '<span style="position: absolute; top: 0%; right: 0%; color: grey; font-size: 1vmin;">' + maxBGText + '</span>';
    graphHTML += '<span style="position: absolute; bottom: 0%; right: 0%; color: grey; font-size: 1vmin;">' + minBGText + '</span>';
    let d = new Date();
    d.setHours(d.getHours() - graphHours);
    let minTimeText = formatTimeHHMMA(d);
    graphHTML += '<span style="position: absolute; bottom: 0%; left: 0%; color: grey; font-size: 1vmin;">' + minTimeText + '</span>';
  }
