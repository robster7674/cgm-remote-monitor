...
function pluginInfo() {
  ...
  if (latestProperties.cage && latestProperties.cage.display) {
    if (latestProperties.cage.level > 0) {
      pluginDisplayValue += ' <div class="cage" style="background-color:grey; color:black; display: inline; border: 1px solid white;">CAGE:' + latestProperties.cage.display.toLowerCase() + '</div>';
    } else {
  ...
  if (latestProperties.sage && latestProperties.sage['Sensor Start'] && latestProperties.sage['Sensor Start'].display) {
    if (latestProperties.sage['Sensor Start'].level > 0) {
      pluginDisplayValue += ' <div class="sage" style="background-color:grey; color:black; display: inline; border: 1px solid white;">SAGE:' + latestProperties.sage['Sensor Start'].display.toLowerCase() + '</div>';
    } else {
  ...
  if (latestProperties.iage && latestProperties.iage.display) {
    if (latestProperties.iage.level > 0) {
      pluginDisplayValue += ' <div class="iage" style="background-color:grey; color:black; display: inline; border: 1px solid white;">IAGE:' + latestProperties.iage.display.toLowerCase() + '</div>';
    } else {
  ...
  if (latestProperties.bage && latestProperties.bage.display) {
    if (latestProperties.bage.level > 0) {
      pluginDisplayValue += ' <div class="bage" style="background-color:grey; color:black; display: inline; border: 1px solid white;">BAGE:' + latestProperties.bage.display.toLowerCase() + '</div>';
    } else {
  ...
  if (latestProperties.upbat && latestProperties.upbat.display) {
    if (latestProperties.upbat.level <= 25) {
      pluginDisplayValue += ' <div class="upbat" style="background-color:grey; color:black; display: inline; border: 1px solid white;">UP:' + latestProperties.upbat.display.toLowerCase() + '</div>';
    } else {
  ...
  if (latestProperties.pump && latestProperties.pump.data && latestProperties.pump.data.status && latestProperties.pump.data.status.display) {
    if (latestProperties.pump.data.level > 0) {
      pluginDisplayValue += ' <div class="pump" style="background-color:grey; color:black; display: inline; border: 1px solid white;">P:' + latestProperties.pump.data.status.display + '</div>';
    } else {
    ...
    if (latestProperties.pump.data.reservoir && latestProperties.pump.data.reservoir.display) {
      if (latestProperties.pump.data.reservoir.level > 0) {
        pluginDisplayValue += ' <div class="reservoir" style="background-color:grey; color:black; display: inline; border: 1px solid white;">R:' + latestProperties.pump.data.reservoir.display.toLowerCase() + '</div>';
      } else {
    ...
    if (latestProperties.pump.data.battery && latestProperties.pump.data.battery.display) {
      if (latestProperties.pump.data.battery.level > 0) {
        pluginDisplayValue += ' <div class="pumpbat" style="background-color:grey; color:black; display: inline; border: 1px solid white;">PB:' + latestProperties.pump.data.battery.display.toLowerCase() + '</div>';
      } else {
  ...
  if (latestProperties.openaps && latestProperties.openaps.status && latestProperties.openaps.status.symbol) {
    if ((latestProperties.openaps.status.symbol !== '⌁') &&
      ...
      pluginDisplayValue += ' <div class="openaps" style="background-color:grey; color:black; display: inline; border: 1px solid white;">OAPS:' + latestProperties.openaps.status.symbol + '</div>';
    } else {
  ...
  if (latestProperties.sensorState && latestProperties.sensorState.lastStateStringShort) {
    if (latestProperties.sensorState.level > 0) {
      pluginDisplayValue += ' <div class="sensorstate" style="background-color:grey; color:black; display: inline; border: 1px solid white;">CGM:' + latestProperties.sensorState.lastStateStringShort;
