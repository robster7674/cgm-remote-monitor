...
function treatmentsDisplay() {
  ...
  if (treatmentData['Profile Switch']) {
    ...
    if (elapsedms < hour) {
      value += "<tr><td>Prof:</td><td>" + treatmentData['Profile Switch'].profile + "</td><td>" + Math.floor(elapsedms / 1000 / 60) + "min ago</td>";
      if (treatmentData['Profile Switch'].duration > 0) {
        value += "<td>for " + treatmentData['Profile Switch'].duration + "min</td>";
      }
      value += "</tr>";
    }
  }
  if (treatmentData['Exercise']) {
    ...
    if (elapsedms < hour) {
      value += "<tr><td>Exer:</td><td>" + treatmentData['Exercise'].notes + "</td><td>" + Math.floor(elapsedms / 1000 / 60) + "min ago</td>";
      if (treatmentData['Exercise'].duration > 0) {
        value += "<td>for " + treatmentData['Exercise'].duration + "min</td>";
      }
      value += "</tr>";
    }
  }
