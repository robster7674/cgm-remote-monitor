...
function graphInfo () {
  ...
  if (graphOverlaySGV != '1') {
    ...
    graphHTML += '<hr style="width: 100%; height: 1px; border: 1px dashed grey; bottom: ' + yPct + '%; margin: 0 auto; position: absolute;">';
    ...
    graphHTML += '<hr style="width: 100%; height: 1px; border: 1px dotted grey; bottom: ' + yPct + '%; margin: 0 auto; position: absolute;">';
