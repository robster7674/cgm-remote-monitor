...
client.render = function render () {
  ...
  if (latestProperties.sensorState) {
    if (latestProperties.sensorState.level > 0) {
      xtraDisplayValue += " CGM:" + latestProperties.sensorState.lastStateStringShort + " VB:" + latestProperties.sensorState.lastVoltageB.toLowerCase();
      xtraAlarm = true;
    } else {
      xtraDisplayValue += " cgm:" + latestProperties.sensorState.lastStateStringShort.toLowerCase() + " vb:" + latestProperties.sensorState.lastVoltageB.toLowerCase();
    }
  }
