...
function graphInfo () {
  ...
  if (graphOverlaySGV != '1') {
    ...
    graphHTML += '<span style="position: absolute; top: 0%; right: 0%; color: grey; font-size: 1vmin; line-height: normal;">' + maxBGText + '</span>';
    graphHTML += '<span style="position: absolute; bottom: 0%; right: 0%; color: grey; font-size: 1vmin; line-height: normal;">' + minBGText + '</span>';
    let d = new Date();
    d.setHours(d.getHours() - graphHours);
    graphHTML += '<span style="position: absolute; bottom: 0%; left: 0%; color: grey; font-size: 1vmin; line-height: normal;">' + formatTimeHHMMA(d) + '</span>';
  }
