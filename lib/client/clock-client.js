...
function graphInfo () {
  ...
  if (graphOverlaySGV != '1') {
    ...
    maxBGText = maxMGDL;  // TBD: convert to mmol if nightscout DISPLAY_UNITS is mmol...
    minBGText = minMGDL;
    ...
    graphHTML += '<span style="position: absolute; bottom: 0%; left: 0%; color: grey; font-size: 1vmin;">' + formatTimeHHMMA(d) + '</span>';
  }
