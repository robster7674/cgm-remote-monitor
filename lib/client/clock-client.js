...
function graphInfo () {
  ...
  if (graphOverlaySGV != '1') {
    ...
    graphHTML += '<span style="position: absolute; top: 100%; right: 0%; color: grey; font-size: 1vmin;">' + maxBGText + '</span>';
    graphHTML += '<span style="position: absolute; bottom: 100%; right: 0%; color: grey; font-size: 1vmin;">' + minBGText + '</span>';
    let d = new Date();
    d.setHours(d.getHours() - graphHours);
    graphHTML += '<span style="position: absolute; bottom: 100%; left: 0%; color: grey; font-size: 1vmin;">' + formatTimeHHMMA(d) + '</span>';
  }
