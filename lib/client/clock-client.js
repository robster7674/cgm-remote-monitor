...
function graphInfo () {
  ...
  if (graphOverlaySGV != '1') {
    ...
    graphHTML += '<span style="position: absolute; bottom: 100%; left: 100%; color: grey; font-size: 1vmin; line-height: normal;">' + maxBGText + '</span>';
    graphHTML += '<span style="position: absolute; top: 100%; left: 100%; color: grey; font-size: 1vmin; line-height: normal;">' + minBGText + '</span>';
    let d = new Date();
    d.setHours(d.getHours() - graphHours);
    graphHTML += '<span style="position: absolute; top: 100%; right: 100%; color: grey; font-size: 1vmin; line-height: normal;">' + formatTimeHHMMA(d) + '</span>';
  }
