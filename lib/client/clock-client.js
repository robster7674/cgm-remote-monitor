...
function graphInfo () {
  ...
  graphHTML += '<hr style="width: 100%; height: 1px; border-top: 2px dashed grey; bottom: ' + yPct + '%; margin: 0 auto; position: absolute;">';
  ...
  graphHTML += '<hr style="width: 100%; height: 1px; border-top: 1px dashed grey; bottom: ' + yPct + '%; margin: 0 auto; position: absolute;">';
